...
const float z_default = -80, z_up = -50, z_boot = z_absolute, z_bow_relative = 25, z_tall = -100;
...
float move_speed = 4;     //movement speed
...
void setup()
{
  ...
  calib_servo(); // executed only if A5 is set to 1
...
void loop()
{
  ...
  //delay(2000);
  //step_forward(10);
  //step_forward_custom(10);
  gyrate(5);
  delay(5000);
  body_side_up_side_down(5);
delay(5000);
  bow(5);
  delay(5000);
  body_twist(5);
delay(5000);
  body_forward_backward(5);
delay(5000);
  body_side_to_side(5);
delay(5000);
  stagger(5);
...
void step_forward_custom(unsigned int step)
{
   // JC - get legs in correct starting position
  move_speed = 1;//leg_move_speed;
